...
# write.table(normalized_counts, file="data/normalized_counts_FB.txt", sep="\t", quote=F, col.names=NA)
...
# thrsh = 1; count=0;
# c_addpcg = c(); c_addpse = c(); c_addri = c(); c_addlnc = c(); c_addnmd = c(); c_addpt = c(); c_addsn = c(); c_addsno = c(); c_addr = c(); c_addmi = c(); c_addgene = c()
...
# # merged_calc = data.frame(medpcg, sd_pcg, medpse, sd_pse, medri, sd_ri, medlnc, sd_lnc, mednmd, sd_nmd, medpt, sd_pt, medsn,sd_sn, medsno, sd_sno, medr, sd_r, medmi, sd_mi) 

# # names(merged_calc) <- c('medpcg', 'sd_pcg', 'medpse', 'sd_pse', 'medri', 'sd_ri', 'medlnc', 'sd_lnc', 'mednmd', 
#   # 'sd_nmd', 'medpt', 'sd_pt', 'medsn','sd_sn', 'medsno', 'sd_sno', 'medr', 'sd_r', 'medmi', 'sd_mi')
...
# ggsave("Violinplot_FB_d0.png", plot = violin_d0)
...
# ggsave("Violinplot_FB_d1.png", plot = violin_d1)
...
# ggsave("Violinplot_FB_d3.png", plot = violin_d3)
...
# ggsave("Violinplot_FB_d7.png", plot = violin_d7)
...
# ggsave("Violinplot_FB_d14.png", plot = violin_d14)
